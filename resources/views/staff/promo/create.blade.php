...
<div class="w-75 d-block mx-auto my-5 p-4">
    <h5 class="text-center mb-3">Buat Promo Bioskop</h5>
    <form method="POST" action="{{ route('staff.promos.store')}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('promo_code')
                is-invalid
            @enderror" id="promo_code" name="promo_code">
            @error('promo_code')
        ...
        <div class="mb-3">
            ...
            @enderror" id="type" name="type">
                <option value="" disabled selected>Tipe Promo</option>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('discount')
                is-invalid
            @enderror" id="discount" name="discount">
            @error('discount')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
